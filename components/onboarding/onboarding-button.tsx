...
export function OnboardingButton({ label, onPress, variant = 'primary' }: OnboardingButtonProps) {
  ...
  return (
    <Pressable
      style={({ pressed }) => [styles.button, { backgroundColor }, pressed && styles.buttonPressed]}
      onPress={onPress}
    >
